...
#define MAP_UNDERGROUND_PATH_NORTH_ENTRANCE      (4 | (1 << 8))
#define MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL  (5 | (1 << 8))
#define MAP_UNDERGROUND_PATH_SOUTH_ENTRANCE      (6 | (1 << 8))
#define MAP_UNDERGROUND_PATH_WEST_ENTRANCE       (7 | (1 << 8))
#define MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL    (8 | (1 << 8))
#define MAP_UNDERGROUND_PATH_EAST_ENTRANCE       (9 | (1 << 8))
#define MAP_DIGLETTS_CAVE_NORTH_ENTRANCE         (10 | (1 << 8))
#define MAP_DIGLETTS_CAVE_B1F                    (11 | (1 << 8))
#define MAP_DIGLETTS_CAVE_SOUTH_ENTRANCE         (12 | (1 << 8))
#define MAP_VICTORY_ROAD_1F                      (13 | (1 << 8))
#define MAP_VICTORY_ROAD_2F                      (14 | (1 << 8))
#define MAP_VICTORY_ROAD_3F                      (15 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B1F                   (16 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B2F                   (17 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B3F                   (18 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B4F                   (19 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_ELEVATOR              (20 | (1 << 8))
#define MAP_SILPH_CO_1F                          (21 | (1 << 8))
#define MAP_SILPH_CO_2F                          (22 | (1 << 8))
#define MAP_SILPH_CO_3F                          (23 | (1 << 8))
#define MAP_SILPH_CO_4F                          (24 | (1 << 8))
#define MAP_SILPH_CO_5F                          (25 | (1 << 8))
#define MAP_SILPH_CO_6F                          (26 | (1 << 8))
#define MAP_SILPH_CO_7F                          (27 | (1 << 8))
#define MAP_SILPH_CO_8F                          (28 | (1 << 8))
#define MAP_SILPH_CO_9F                          (29 | (1 << 8))
#define MAP_SILPH_CO_10F                         (30 | (1 << 8))
#define MAP_SILPH_CO_11F                         (31 | (1 << 8))
#define MAP_SILPH_CO_ELEVATOR                    (32 | (1 << 8))
#define MAP_POKEMON_MANSION_1F                   (33 | (1 << 8))
#define MAP_POKEMON_MANSION_2F                   (34 | (1 << 8))
#define MAP_POKEMON_MANSION_3F                   (35 | (1 << 8))
#define MAP_POKEMON_MANSION_B1F                  (36 | (1 << 8))
#define MAP_SAFARI_ZONE_CENTER                   (37 | (1 << 8))
#define MAP_SAFARI_ZONE_EAST                     (38 | (1 << 8))
#define MAP_SAFARI_ZONE_NORTH                    (39 | (1 << 8))
#define MAP_SAFARI_ZONE_WEST                     (40 | (1 << 8))
#define MAP_SAFARI_ZONE_CENTER_REST_HOUSE        (41 | (1 << 8))
#define MAP_SAFARI_ZONE_EAST_REST_HOUSE          (42 | (1 << 8))
#define MAP_SAFARI_ZONE_NORTH_REST_HOUSE         (43 | (1 << 8))
#define MAP_SAFARI_ZONE_WEST_REST_HOUSE          (44 | (1 << 8))
#define MAP_SAFARI_ZONE_SECRET_HOUSE             (45 | (1 << 8))
#define MAP_CERULEAN_CAVE_1F                     (46 | (1 << 8))
#define MAP_CERULEAN_CAVE_2F                     (47 | (1 << 8))
#define MAP_CERULEAN_CAVE_B1F                    (48 | (1 << 8))
#define MAP_POKEMON_LEAGUE_LORELEIS_ROOM         (49 | (1 << 8))
#define MAP_POKEMON_LEAGUE_BRUNOS_ROOM           (50 | (1 << 8))
#define MAP_POKEMON_LEAGUE_AGATHAS_ROOM          (51 | (1 << 8))
#define MAP_POKEMON_LEAGUE_LANCES_ROOM           (52 | (1 << 8))
#define MAP_POKEMON_LEAGUE_CHAMPIONS_ROOM        (53 | (1 << 8))
#define MAP_POKEMON_LEAGUE_HALL_OF_FAME          (54 | (1 << 8))
#define MAP_ROCK_TUNNEL_1F                       (55 | (1 << 8))
#define MAP_ROCK_TUNNEL_B1F                      (56 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_1F                   (57 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B1F                  (58 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B2F                  (59 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B3F                  (60 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B4F                  (61 | (1 << 8))
#define MAP_POKEMON_TOWER_1F                     (62 | (1 << 8))
#define MAP_POKEMON_TOWER_2F                     (63 | (1 << 8))
#define MAP_POKEMON_TOWER_3F                     (64 | (1 << 8))
#define MAP_POKEMON_TOWER_4F                     (65 | (1 << 8))
#define MAP_POKEMON_TOWER_5F                     (66 | (1 << 8))
#define MAP_POKEMON_TOWER_6F                     (67 | (1 << 8))
#define MAP_POKEMON_TOWER_7F                     (68 | (1 << 8))
#define MAP_POWER_PLANT                          (69 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B4F               (70 | (1 << 8))
#define MAP_MT_EMBER_EXTERIOR                    (71 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_1F              (72 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_2F              (73 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_3F              (74 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT                      (75 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B5F               (76 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_1F                (77 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B1F               (78 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B2F               (79 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B3F               (80 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B1F_STAIRS        (81 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B2F_STAIRS        (82 | (1 << 8))
#define MAP_THREE_ISLAND_BERRY_FOREST            (83 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE    (84 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_1F          (85 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_B1F         (86 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_BACK        (87 | (1 << 8))
#define MAP_FIVE_ISLAND_ROCKET_WAREHOUSE         (88 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_1F            (89 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B1F           (90 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B2F           (91 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B3F           (92 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B4F           (93 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_SAPPHIRE_ROOM (94 | (1 << 8))
#define MAP_SIX_ISLAND_PATTERN_BUSH              (95 | (1 << 8))
#define MAP_SIX_ISLAND_ALTERING_CAVE             (96 | (1 << 8))
#define MAP_VIRIDIAN_FOREST2                     (97 | (1 << 8))
#define MAP_VIRIDIAN_FOREST3                     (98 | (1 << 8))
#define MAP_MEW_CAVE1                            (99 | (1 << 8))
#define MAP_SAFARI_ZONE2                         (100 | (1 << 8))
#define MAP_SAFARI_ZONE3                         (101 | (1 << 8))
#define MAP_SAFARI_ZONE4                         (102 | (1 << 8))
#define MAP_SAFARI_ZONE5                         (103 | (1 << 8))
#define MAP_VIRIDIAN_FOREST_CAVE1                (104 | (1 << 8))
...
#define MAP_PALLET_NEW_LAB                 (4 | (4 << 8))
#define MAP_PALLET_NEW_LAB_BASEMENT        (5 | (4 << 8))
...
#define MAP_ROUTE2NEW_HOUSE                       (4 | (15 << 8))
